...
- Session record 2026-06-14: build record: Servo, the Constant, the DO-NOT-REPEAT block, and the em-dash structural fix, 2026-06-14. Moved to `session-2026-06-14-servo-constant-build.md` in the private `claude-preferences-private` repo (2026-07-07) as part of the public/private split; not publicly linkable since that repo stays private.
